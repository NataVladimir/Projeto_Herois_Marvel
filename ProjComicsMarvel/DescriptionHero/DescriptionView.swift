...
class DescriptionView: UIView {
    ...
    lazy var descriHeroLabel: UILabel = {
        ...
        num.lineBreakMode = .byWordWrapping
        num.textAlignment = .justified
        return num
    }()
    ...
    private func setUpContraints(){
        NSLayoutConstraint.activate([
            ...
            self.imageHero.widthAnchor.constraint(equalToConstant: 250),
            self.imageHero.heightAnchor.constraint(equalToConstant: 250),
