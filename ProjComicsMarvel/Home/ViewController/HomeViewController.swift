...
extension HomeViewController: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath){
        ...
        if self.screemHeros == false{
            _ = homeViewModel.heros[indexPath.row]
            let detailViewController = DescriptionViewController()
            
            // encaminhando variaveis para descripitionController
            detailViewController.hrUrl = homeViewModel.heros[tableView.indexPathForSelectedRow!.row]
            ...
            webVc.heroUrlS = selectedHero.urlWebSave
