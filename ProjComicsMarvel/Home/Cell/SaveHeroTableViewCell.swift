...
class SaveHeroTableViewCell: UITableViewCell {
    ...
    lazy var descriHero: UILabel = {
        ...
        num.textColor = .white
        num.textRect(forBounds: .zero, limitedToNumberOfLines: 1)
        return num
    }()
    ...
    private func setUpConstraints(){
        NSLayoutConstraint.activate([
            ...
            self.descriHero.trailingAnchor.constraint(equalTo: self.trailingAnchor),
            self.descriHero.bottomAnchor.constraint(equalTo: self.descriHero.safeAreaLayoutGuide.bottomAnchor)
